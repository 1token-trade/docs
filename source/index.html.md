...
1Token提供历史行情的下载，具体教程请查看[历史数据](https://1token-trade.github.io/docs/hist-data)一节。
...
你可以通过API去下载所有的历史tick行情[Hist Quote](https://1token-trade.github.io/docs/hist-data)。
